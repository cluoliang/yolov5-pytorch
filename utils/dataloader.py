...
class YoloDataset(Dataset):
    ...
    def get_target(self, targets):
        ...
        for l in range(num_layers):
            ...
            #-------------------------------------------------------#
            #   一个目标分别于9个anchor的宽高比值
            #   0:10.1999,15.07,0.098,0.0663--> 15.07
            #   1:6.3749,6.533,0.156,0.153  --> 6.5
            #   2:3.09,8.521,0.323,0.117    --> 8.52
            #   3:3.399,3.213,0.294,0.311   --> 3.339
            #   4:1.645,4.355,0.607,0.229   --> 4.35  --> 15.07,6.5,8.52,3.339,4.35,1.72,2.17,4.52,3.65
            #   5:1.7288,1.677,0.5784,0.607 --> 1.72
            #   6:0.879,2.177,1.13,0.459    --> 2.17
            #   7:0.6538,0.9898,1.5294,1.01 --> 4.52
            #   8:0.273,0.601,3.656,1.663   --> 3.65
            
            #-------------------------------------------------------#
            max_ratios           = np.max(ratios, axis = -1)
            #-------------------------------------------------------#
            
            # 遍历所有目标 ratio保存着单个目标分别于9个anchor的宽高最大比值
            # ratio = [15.07,6.5,8.52,3.339,4.35,1.72,2.17,4.52,3.65]
            #-------------------------------------------------------#
